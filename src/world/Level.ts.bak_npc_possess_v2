...
// Sensor collider
    ...
    try {
      ...
      const __n = Array.isArray((globalThis as any).__sweetlandNpcList) ? (globalThis as any).__sweetlandNpcList.length : 0;
      console.info(`[SweetLand] WALK-PLACE: exposed ${__n} NPCs to globalThis.__sweetlandNpcList`);
    } catch (e) {
      console.warn("[SweetLand] WALK-PLACE: failed to expose NPC list", e);
    }
}
}
