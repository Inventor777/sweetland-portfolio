...
// ---------------------------------------------------------------------------
// Legacy shim: older App.ts builds call level.applyNpcPlacements(...).
// The autospawn system applies placements during NPC spawn, so this is a no-op
// kept only to avoid runtime crashes.
// ---------------------------------------------------------------------------
applyNpcPlacements(_placements: any) {
  // no-op (placements are applied during spawn)
}
