...
(function __slInitNpcOverridesV8d(){
  ...
  addWithAliases("Grummy 01", { name: "Goldie Gum", lines: [
    "Hi, welcome to the Chloeverse! If you've never been here before, feel free to explore Chloe's Candy Castle! If you're looking for her work, feel free to explore the castle and meet everyone along the way, or use the one through four to teleport instantly to the portals. Thanks for stopping by!"
  ]});
...
const SWEETLAND_NPC_DIALOGUE_BY_NPC_NAME: Record<string, string[]> = {
  "Grummy 01": ["Hi, welcome to the Chloeverse! If you've never been here before, feel free to explore Chloe's Candy Castle! If you're looking for her work, feel free to explore the castle and meet everyone along the way, or use the one through four to teleport instantly to the portals. Thanks for stopping by!"],
...
const __sweetlandNpcCanon = (s: string) => {
  const raw = String(s || "");
  // Normalize so that:
  // - "Sweetbloom 01" and "Sweetbloom 1" match
  // - "GummiBear01" and "GummiBear 01" match
